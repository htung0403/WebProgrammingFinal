...
%>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Cung cấp cà phê</h1>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 ps-lg-0">
                        <div class="section-title text-start">
                            <h1 class="display-9 mb-4">Tại sạo phải chọn Let's Cafe </h1>
                        </div>
                        <p class="mb-4 pb-2">Để đảm bảo chất lượng tối đa, Let's Café tin tưởng vào sự tài năng của những thợ rang chuyên nghiệp. Quy trình rang tỉ mỉ giúp tạo ra hương thơm đặc trưng và vị cà phê mạnh mẽ, đáp ứng đúng Gu của những người yêu thích cà phê đậm đà.</p>
                        <div class="row g-4">
                            <div class="col-6">
                ...
                <div class="col-lg-6 pe-lg-0" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="Lets/Xuong.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
